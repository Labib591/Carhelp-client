    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 font-display">
            <div className="bg-white p-6 rounded-xl w-[90%] max-w-md shadow-lg space-y-2">
                <h2 className="text-2xl font-semibold text-[var(--primary-950)]">Book {car.model}</h2>
                <p className="text-[var(--primary-800)] text-xl font-bold">Price: ${car.price} per day</p>
                ...
                <div>
                    ...
                    <button type="submit" className="px-4 py-2 bg-[var(--primary-color)] text-[var(--primary-950)] rounded-full hover:bg-[var(--primary-300)]">
                        Confirm
                    </button>
                </div>
                    </form>
