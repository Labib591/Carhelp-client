...
const WhyUS = () => {
    return ( <div className="flex flex-col items-center gap-8 my-20 font-display"> 
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-4 w-[90%] mx-auto">
            <div className="flex flex-col items-center gap-4 inset-ring-[var(--primary-color)] inset-ring-2 rounded-2xl py-8 px-4 bg-[var(--primary-100)] hover:scale-105 hover:transform duration-300">
                <div className="">
